...
class Model:
    ...
    def title_search(self):
        ...
        self.cur.execute("""SELECT title, language, popularity, genre, 'https://image.tmdb.org/t/p/w500' || movie_poster as poster_url
            FROM movies m
            JOIN genres g
            ON m.genre_id = g._id
    ...
    def date_search(self):
        ...
        self.cur.execute("""SELECT title, release_date, popularity, genre, 'https://image.tmdb.org/t/p/w500' || movie_poster as poster_url 
            FROM movies m
            JOIN genres g 
            ON m.genre_id= g._id
